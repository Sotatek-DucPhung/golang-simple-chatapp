    ...
    <>
      <div className='flex flex-col w-full'>
        <div className='flex justify-end p-4'>
          <button
            className='p-2 rounded-md bg-blue text-white text-sm'
          ...
          <div className='flex md:flex-row px-4 py-2 bg-grey md:mx-4 rounded-md'>
            <div className='flex w-full mr-4 rounded-md border border-blue'>
              <textarea
                ...
                className='w-full h-10 p-2 rounded-md focus:outline-none text-sm'
                style={{ resize: 'none', height: '50px', maxHeight: '150px', overflowY: 'auto' }}
              />
            </div>
